{{-- Guest (login page) header/menubar extracted from authentication-signin-with-header-footer.html --}}
<header>
  <nav class="navbar navbar-expand-lg navbar-light bg-white rounded-0 border-bottom">
    <div class="container">
      <a class="navbar-brand" href="#"><img src="{{ asset('assets/images/brand-logo-2.png') }}" width="140" alt=""/></a>

...
class SalesOrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'salesDraft' => [
                'id' => $this->salesDraft->id ?? null,
                'saleId' => $this->salesDraft->saleId ?? null,
            ],
            'company' => [
            ...
            'sales_details' => SalesOrderDetailsResource::collection($this->salesDetails),

            'egg_returns' => $this->returnDetails->map(function ($item) {
                ...
                return [
                    ...
                    'return_amount'  => round($returnQty * $salePrice, 2),
                ];
            })->values(),
